...
nn = NeuralNetwork2(training_x, training_y, 10, sigmoid_activation, tanh_activation)
...
nn = NeuralNetwork2(training_x, training_y, 10, sigmoid_activation, sigmoid_activation)
